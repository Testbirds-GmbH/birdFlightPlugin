...
import birdflight.BirdflightRemoteRecorder;
import birdflight.BirdflightUploader;
...
public class TestflightRemoteRecorderTest {
    ...
    public void setUpMocks() {
        ...
        uploader = mock(BirdflightUploader.class);
    ...
    public void testPrettySpeed() {
        assertEquals("NaN bps", BirdflightRemoteRecorder.prettySpeed(Float.NaN));
    }

    @Test
    public void findMultipleFiles() throws Throwable {
        BirdflightUploader.UploadRequest ur = createTestUploadRequest(null);

        BirdflightRemoteRecorder remoteRecorder = new BirdflightRemoteRecorder(tmpDir.toString(), ur, listener);
    ...
    public void findFilesWithAbsolutePaths() throws Throwable {
        BirdflightUploader.UploadRequest ur = createTestUploadRequest(apk1.getPath());
    ...
    public void findFilesWithRelativePaths() throws Throwable {
        BirdflightUploader.UploadRequest ur = createTestUploadRequest("a/d/test.apk");
    ...
    static class IsUploadRequestForRightFiles extends ArgumentMatcher<BirdflightUploader.UploadRequest> {
        File file;
        File dsymFile;
        ...
        public boolean matches(Object request) {
            BirdflightUploader.UploadRequest r = (BirdflightUploader.UploadRequest) request;
    ...
    private BirdflightUploader.UploadRequest createTestUploadRequest(String paths) {
